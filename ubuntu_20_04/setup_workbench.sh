...
# ----------------------------------------------------
echo -e $RESET $GREEN $NL"Setting up Visual Studio Code" $RESET
find_install_from_apt software-properties-common
find_install_from_apt apt-transport-https
find_install_from_apt wget
...
echo "alias frar='bash ~/.custom_scripts/replace_in_files_recursive.sh'" >> ~/.bashrc
